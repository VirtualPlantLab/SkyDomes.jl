...
"""
    sky(mesh; Idir = 0.77, nrays_dir = 100_000, theta_dir = 0.0, phi_dir = 0.0,
               ...
               α = π, alpha_soil = 0.0, beta_soil = π, warn_slope = true,
               kwargs...)
...
- `α`: The azimuth of the local X axis (radians, default `π`).
- `alpha_soil`: The slope inclination of the soil (radians; `0` = horizontal, `π/2` = vertical; default `0`).
- `beta_soil`: The azimuth of the slope normal (radians; e.g. `π` = south-facing; default `π`).
